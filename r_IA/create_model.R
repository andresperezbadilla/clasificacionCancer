#librerías utiliadas (puede que necesiten instalar una o más de estas librerías, en ese caso, utilicen install.library(caTools)
library(rpart)
library(rpart.plot)
library(caTools)
...
setwd('C:\\Users\\Efren\\Desktop\\coloquio')
